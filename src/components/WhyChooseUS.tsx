    ...
    >
      ...
      <div className="flex flex-col flex-1 p-7">
        ...
        >
          ...
          <span className="text-[11px] font-black uppercase tracking-[0.28em] leading-[1.5] relative z-10" style={{ color: "rgba(212,175,55,0.55)" }}>{r.phase}</span>
        </div>
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-3 mb-5">
        ...
        <div>
          <p className="text-[12px] font-black uppercase tracking-[0.32em] font-sans" style={{ color: G }}>Proof of Execution</p>
      ...
      <div className="flex items-center gap-3 flex-wrap mt-4">
        <span className="text-[12px] font-black uppercase tracking-[0.35em] font-sans" style={{ color: "rgba(212,175,55,0.5)" }}>Trusted by</span>
        {TRUSTED.map((name) => (
          <div
            key={name}
            className="inline-flex items-center gap-2 px-[14px] py-[5px] rounded-full border text-[12px] font-black uppercase tracking-[0.18em] font-sans cursor-default transition-all duration-250 hover:border-[rgba(212,175,55,0.4)] hover:bg-[rgba(212,175,55,0.07)]"
