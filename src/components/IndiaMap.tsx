...
const locations = [
  ...
  },
  {
    id: "Bengaluru",
    name: "Bengaluru",
    corridor: "Hosur-Bangaluru BLR",
    acres: 120,
    sqft: "2.7 Mn",
    status: "Identified",
    x: 47.5,
    y: 40.2,
    description: "Nelamangala · Hoskote · Bommasandra",
    image: hosurImg,
  },
   {
    id: "Coimbatore",
    name: "Coimbatore",
    corridor: "Chennai-coimbatore BLR",
    acres: 1.5,
    sqft: "2.7 Mn",
    status: "Identified",
    x: 32.5,
    y: 45.2,
    description: "Western Tamil Nadu manufacturing belt",
    image: chennai,
  },
     {
    id: "Madurai",
    name: "Madurai",
    corridor: "Chennai-Madurai BLR",
    acres: 1.2,
    sqft: "69 Mn",
    status: "Identified",
    x: 52.5,
    y: 65.2,
    description: "South Tamil Nadu logistics node",
    image: chennai,
  },
   {
    id: "Pondicherry",
    name: "Pondicherry",
    corridor: "Madurai-Pandicherry BLR",
    acres: 16,
    sqft: "72,000 Mn",
    status: "Identified",
    x: 72.5,
    y: 50.2,
    description: "Puducherry industrial corridor",
    image: chennai,
  },
];
    ...
    >
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6 mb-12">
          <div>
            <div className="inline-flex items-center px-3 py-1 rounded-full border border-primary/15 text-primary/60 bg-primary/[0.03] mb-6 text-sm font-bold uppercase tracking-widest">
              Scalable Pipeline
            </div>
            <h2
            ...
            >
              <div className="flex items-center justify-between px-7 pt-6 pb-4">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-[12px] font-black uppercase tracking-[0.3em] text-[rgba(10,20,40,0.4)]">
                ...
                <div className="absolute inset-0 z-20">
                  {locations.map((loc) => (
                    ...
                    >
                      ...
                      <div
                        className={`absolute inset-0 rounded-full animate-ping opacity-40 pointer-events-none ${selectedId === loc.id ? "bg-accent" : "bg-[rgba(212,175,55,0.2)]"
                          }`}
                      ...
                      <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
                        <div className={`relative flex flex-col items-center transition-transform duration-500 ${hoveredId === loc.id || selectedId === loc.id ? "scale-125" : "scale-100"
                          ...
                          <div className="absolute top-full mt-2 text-center whitespace-nowrap">
                            <span
                              className={`inline-block text-[11px] font-black tracking-widest px-2 py-0.5 rounded transition-all duration-500 shadow-xl ${selectedId === loc.id ? "bg-accent text-white" : "text-[rgba(212,175,55,0.6)] bg-black/60 backdrop-blur-md"
                                }`}
                            >
              ...
              {/* <div className="flex items-center gap-5 flex-wrap px-7 py-4 border-t border-black/5 bg-gray-50/50">
                {locations.map((loc) => (
                  ...
                  >
                    <div
                      className={`w-2 h-2 rounded-full transition-all duration-300 ${selectedId === loc.id ? "bg-accent scale-150" : "bg-[rgba(10,20,40,0.2)] group-hover:bg-[rgba(10,20,40,0.4)]"}`}
                    />
                    <span
        ...
        <div className="mt-12 flex flex-wrap justify-center gap-4">
          {locations.map((loc, i) => (
            <button
              key={loc.id}
              onClick={() => setSelectedId(loc.id)}
              className={`px-6 py-3 rounded-2xl border transition-all font-black uppercase text-[12px] tracking-widest ${selectedId === loc.id ? "bg-accent border-transparent text-white shadow-xl shadow-[rgba(212,175,55,0.2)]" : "bg-white border-black/5 text-[rgba(10,20,40,0.4)] hover:bg-gray-50"
                }`}
            >
