    ...
    <main className="min-h-screen bg-white">
      ...
      <section className="relative h-[70vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10 w-full">
            ...
            <motion.h1 initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} className="text-6xl md:text-8xl font-serif font-black text-white leading-none uppercase tracking-tighter">Warehouse <br /><span className="text-transparent bg-clip-text bg-gradient-to-r from-accent via-white to-white italic">Construction</span></motion.h1>
