      ...
      <section className="relative pt-60 pb-32 bg-primary overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          ...
          <motion.h1 
            ...
            className="text-4xl md:text-6xl lg:text-7xl font-serif font-black text-white leading-none uppercase tracking-tighter"
          >
            Join the <br />
      ...
      <section className="py-32 bg-white">
        <div className="max-w-7xl mx-auto px-6">
            ...
            <div className="space-y-12">
                <h2 className="text-4xl md:text-6xl font-serif font-black text-primary mb-16 uppercase tracking-tighter">Strategic <span className="text-accent">Opportunities</span></h2>
